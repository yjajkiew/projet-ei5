...
@synthesize pinNumberTextField, modeSegmentedControl, tableView, arduinos;
...
- (IBAction)sendButton:(id)sender {
    ...
    if(errorMessage != nil) {
        ...
        NSString *command = [NSString stringWithFormat:@"%@/arduinos/pinRead/%@/%@/%@/%@", globalServerAddress, arduino.ip, arduino.ip, pinNumberTextField.text,mode];
